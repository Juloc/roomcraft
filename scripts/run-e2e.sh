...
Assets__StoragePath="$ASSET_DIR" dotnet run   --project src/server/RoomCraft.Host/RoomCraft.Host.csproj   --configuration Release   --no-build   --no-launch-profile   --urls "http://localhost:5050" >"$API_LOG" 2>&1 &
API_PID=$!
