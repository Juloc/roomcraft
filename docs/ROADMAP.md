...
- Playwright full-stack critical flow (PostgreSQL + ASP.NET + Chromium) ✅
...
A full-stack Playwright test now protects the core path below. GLB-import-specific browser coverage can be added separately without weakening this central regression test:
